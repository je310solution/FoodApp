...
import 'package:foodapps/utils/validate.dart';
import 'package:foodapps/styles/styles.dart';
import 'package:foodapps/widgets/styled_flat_button.dart';
...
class PasswordResetFormState extends State<PasswordResetForm> {
  ...
  Future<void> submit() async {
    ...
    if (form.validate()) {
      bool success =
          await Provider.of<AuthProvider>(context).passwordReset(username);
      if (success) {
